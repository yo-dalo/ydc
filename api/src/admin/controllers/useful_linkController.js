...
exports.getById = async (req, res) => {
  try {
    const item = await UsefulLinkService.getById(req.params.id, req.admin.Branch_Id);
...
exports.getForUpdate = async (req, res) => {
  try {
    const item = await UsefulLinkService.getForUpdate(req.params.id, req.admin.Branch_Id);
    if (!item) return errorResponse(res, "Useful Link not found", 404);
    return successResponse(res, "Useful Link fetched successfully", item);
  } catch (error) {
    return errorResponse(res, error.message);
...
exports.create = async (req, res) => {
  try {
    const id = await UsefulLinkService.create(req.body, req.admin.Branch_Id);
...
exports.update = async (req, res) => {
  try {
    const updated = await UsefulLinkService.update(req.params.id, req.body, req.admin.Branch_Id);
...
exports.delete = async (req, res) => {
  try {
    const deleted = await UsefulLinkService.delete(req.params.id, req.admin.Branch_Id);

...
exports.getById = async (req, res) => {
  try {
    const item = await MessagesService.getById(req.params.id, req.admin.Branch_Id);
...
exports.getForUpdate = async (req, res) => {
  try {
    const item = await MessagesService.getForUpdate(req.params.id, req.admin.Branch_Id);
    if (!item) return errorResponse(res, "Messages not found", 404);
    return successResponse(res, "Messages fetched successfully", item);
  } catch (error) {
    return errorResponse(res, error.message);
...
exports.create = async (req, res) => {
  try {
    const id = await MessagesService.create(req.body, req.file?.filename, req.admin.Branch_Id);
...
exports.update = async (req, res) => {
  try {
    const updated = await MessagesService.update(req.params.id, req.body, req.file?.filename, req.admin.Branch_Id);
...
exports.delete = async (req, res) => {
  try {
    const deleted = await MessagesService.delete(req.params.id, req.admin.Branch_Id);

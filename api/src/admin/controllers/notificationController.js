...
exports.getById = async (req, res) => {
  try {
    const item = await NotificationService.getById(req.params.id, req.admin.Branch_Id );
...
exports.getForUpdate = async (req, res) => {
  try {
    const item = await NotificationService.getForUpdate(req.params.id, req.admin.Branch_Id);
    if (!item) return errorResponse(res, "Notification not found", 404);
    return successResponse(res, "Notification fetched successfully", item);
  } catch (error) {
    return errorResponse(res, error.message);
...
exports.create = async (req, res) => {
  try {
    const id = await NotificationService.create(req.body, req.admin.Branch_Id);
...
exports.update = async (req, res) => {
  try {
    const updated = await NotificationService.update(req.params.id, req.body, req.admin.Branch_Id);
...
exports.delete = async (req, res) => {
  try {
    const deleted = await NotificationService.delete(req.params.id, req.admin.Branch_Id);

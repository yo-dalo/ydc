...
exports.getById = async (req, res) => {
  try {
    const item = await AdmissionOpenMessageService.getById(req.params.id, req.admin.Branch_Id);
...
exports.getForUpdate = async (req, res) => {
  try {
    const item = await AdmissionOpenMessageService.getForUpdate(req.params.id, req.admin.Branch_Id);
    if (!item) return errorResponse(res, "Admission Open Message not found", 404);
    return successResponse(res, "Admission Open Message fetched successfully", item);
  } catch (error) {
    return errorResponse(res, error.message);
...
exports.create = async (req, res) => {
  try {
    const id = await AdmissionOpenMessageService.create(req.body, req.file?.filename, req.admin.Branch_Id);
...
exports.update = async (req, res) => {
  try {
    const updated = await AdmissionOpenMessageService.update(req.params.id, req.body, req.file?.filename, req.admin.Branch_Id);
...
exports.delete = async (req, res) => {
  try {
    const deleted = await AdmissionOpenMessageService.delete(req.params.id, req.admin.Branch_Id);

...
exports.create = async (req, res) => {
  try {
    const id = await AdmissionOpenMessageService.create(req.body, req.file?.filename);
...
exports.update = async (req, res) => {
  try {
    const updated = await AdmissionOpenMessageService.update(req.params.id, req.body, req.file?.filename);
